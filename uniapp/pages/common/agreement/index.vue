...
const AGREEMENT_SECTIONS: AgreementSection[] = [
	{
		...
		items: [
			...
			'你通过微信授权登录、访问页面、使用题库、练习、考试、笔记、收藏、评论、会员兑换等功能，或点击同意本协议，即视为你已阅读、理解并同意本协议全部内容。',
	...
	},
	{
		title: '三、学习内容与服务规则',
		items: [
			'本应用提供考研政治相关题库、练习、考试、错题、收藏、笔记、排行榜等学习辅助能力，相关内容仅供学习参考，不构成考试结果、录取结果或其他确定性承诺。',
			'你在使用笔记、评论、反馈等互动功能时，应遵守法律法规、公序良俗和平台规则，不得发布违法违规、侵权、广告营销、恶意刷量、干扰服务秩序或与学习场景无关的内容。',
	...
	},
	{
		...
		items: [
			...
			'你在本应用中提交的反馈、评论、笔记等内容，应保证你拥有合法权利；你同意本应用可在提供、优化和展示服务所需范围内使用相关内容。'
		]
	},
	{
		title: '七、个人信息保护',
