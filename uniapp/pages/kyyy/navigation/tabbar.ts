 ...
 * @logic 1. 维护首页、作文、单词、翻译、我的五个导航项；2. 为每项提供 pagePath、图标与导航类型；3. 通过工厂函数返回浅拷贝，避免运行时直接修改常量配置。
 * @dependencies Component: @/components/kyyy/kyyy-tabbar.vue, Page: @/pages/kyyy/practice/index
 * @index_tags 考研英语, 底部导航, tabbar, 单词, 导航配置
 * @author holic512
 */
